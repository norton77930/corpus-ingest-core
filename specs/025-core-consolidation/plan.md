...
src/corpus_ingest_core/path_safety.py          (new)
src/corpus_ingest_core/run_report_io.py        (new)
src/corpus_ingest_core/mcp_runtime.py          (new)
src/corpus_ingest_core/mcp_tools_read.py       (new)
src/corpus_ingest_core/mcp_tools_side_effect.py (new)
src/corpus_ingest_core/mcp_tools_corpus_workflows.py (new)
src/corpus_ingest_core/mcp_tools_verified_report_queries.py (new)
src/corpus_ingest_core/mcp_server.py           (becomes facade)
src/corpus_ingest_core/storage.py              (env-overridable DATA_DIR)
