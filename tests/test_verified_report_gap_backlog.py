...
def test_gap_backlog_reuses_coverage_gaps_and_is_zero_write(
    ...
    from podcast_ingest_core import list_verified_report_gap_backlog, storage
    ...
    monkeypatch.setattr(
        "podcast_ingest_core.verified_report_gap_backlog.list_verified_research_report_coverage",
        fake_coverage,
    )
