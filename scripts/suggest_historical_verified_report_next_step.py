...
def build_parser() -> argparse.ArgumentParser:
    parser = _ArgumentParser(description="Suggest one next human-gated step toward a historical verified report.")
...
def main(argv: list[str] | None = None) -> int:
    try:
        ...
        result = suggest_historical_verified_report_next_step(args.podcast_id, args.episode_ref)
        print(
            json.dumps(
