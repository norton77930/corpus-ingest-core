...
from podcast_ingest_core import PodcastIngestCoreError, generate_industry_chain_mapping


def main() -> None:
    parser = argparse.ArgumentParser(
        description="產生單一 podcast episode 的 deterministic industry chain mapping。"
    )
