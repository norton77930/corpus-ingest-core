...
`main` is at `b2aabb7`, **5 commits ahead of `origin/main`, not pushed.** That
merge landed two features:
...
`main` is **5 commits ahead of `origin/main` and unpushed**. Confirm with the
user before pushing; this session did not push it.
