...
22. MCP tools expose read/search, selected side-effect tools, research workflow, and the human-controlled completion workflow. The reviewed local stdio registry contains exact 13 tools; completion does not load `.env` or rebuild cache automatically.
