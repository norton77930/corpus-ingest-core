...
```powershell
python -m pytest tests/test_repository_secret_boundary.py tests/test_repository_gitignore_policy.py tests/test_mcp_tool_registry_contract.py tests/test_llm_ack_guard_contracts.py tests/test_llm_cli_no_leak.py tests/test_cache_rebuild_guard.py
```
